...
<div class="modal fade bd-example-modal-lg contact" tabindex="-1" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content p-4">
            <h4 class="pb-2">Add New Category</h4>
            <hr>
            <form class="forms-sample" action="{{ route('product-category.store') }}" method="POST" enctype="multipart/form-data"> 
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Income Account</label>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Expense Account</label>
                ...
                <button type="submit" class="btn btn-primary me-2 w-100">Save Product Categories</button>
            </form>
        </div>
    </div>
</div>
...
<div class="modal fade bd-example-modal-lg contact" tabindex="-1" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="EditContact{{ $d->id }}">
    <div class="modal-dialog modal-lg">
        <div class="modal-content p-4">
            ...
            <hr>
            <form class="forms-sample" action="{{ route('product-category.update', $d->id) }}" method="POST" enctype="multipart/form-data"> 
                @csrf 
                @method('PUT')
                <div class="row">
                    <div class="col-md-12">
                ...
                <button type="submit" class="btn btn-primary me-2 w-100">Update Product Categories</button>
            </form>
        </div>
    </div>
</div>
    ...
    function showDeleteDataDialog(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const deleteUrl = "{{ route('product-category.destroy', ':id') }}".replace(':id', id);
                fetch(deleteUrl, {
                    method: 'DELETE',
                    headers: {
