        ...
        <div class="card-title">
            <div class="row">
                ...
                <div class="col-md-6 text-right align-self-center">
                    <a href="" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target=".contact">Add A UOM</a>
                </div>
            </div>
        </div>
...
<div class="modal fade bd-example-modal-lg contact" tabindex="-1" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content p-4">
            ...
            <hr>
            <form class="forms-sample" action="{{ route('uom.store') }}" method="POST" enctype="multipart/form-data"> 
                @csrf 
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="exampleInputUsername1" class="form-label">Categories</label>
                            <select name="uom_categories" id="" class="form-control">
                ...
                <button type="submit" class="btn btn-primary me-2 w-100">Save UOM</button>
            </form>
        </div>
    </div>
</div>
